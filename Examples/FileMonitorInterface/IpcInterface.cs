...
namespace FileMonitorInterface
{
    ...
    /// </summary>
    /// <remarks>
    /// Both the client (FileMonitorInterceptor) and the server (FileMonitorController) access the methods and
    /// properties of this same interface.
    /// </remarks>
    public class IpcInterface : MarshalByRefObject
    {
        ...
        /// </summary>
        /// <remarks>
        /// The message isn't really "sent". Rather, an event handler is fired, and the server has hopefully subscribed
