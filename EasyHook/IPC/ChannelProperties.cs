...
#region Properties
        ...
        /// An <see cref="ArgumentException"/> is thrown if the given <paramref name="value"/> contains any of the
        /// following values:
        /// "_I", "_R" or "/"
        /// </exception>
        ...
        public string ChannelName
        {
            get
            {
                if (_channelName == null)
                    return null;
                return _localEndPointIsInstantiator
                 ? _channelName + _PostfixInstantiatorSide : _channelName +
                                                                                               _PostfixRemoteSide;
            }
        }
        ...
        public string Url
        {
            get
            {
                return ChannelName != null &&
                       EndPointName != null
                 ? _UrlPrefix + ChannelName + _Seperator + EndPointName : null;
            }
        }
...
#region Public Methods
        ...
        {
            return new Hashtable(2){{"name", EndPointName}, {"portName", ChannelName}};
        }

        /// <summary>
        /// Gets the <see cref="ChannelProperties"/> that are expected to be used by the remote endpoint's outgoing
        /// channel.
        /// </summary>
        /// <returns></returns>
        public ChannelProperties GetRemoteEndpointChannelProperties()
        {
            return new ChannelProperties{_endPointName = _endPointName, _channelName = _channelName,
...
#region Public Static Methods
        ...
        public static ChannelProperties CreateRandomChannelProperties()
        {
            ...
            return new ChannelProperties{_endPointName = randomName, _channelName = randomName,
        ...
        /// </exception>
        /// <exception cref="ArgumentException">
        /// An <see cref="ArgumentException"/> is thrown if the given <paramref name="url"/> is not a valid IPC channel
        /// url.
        /// </exception>
...
#region Private Static Methods
        ...
        {
            if (value.EndsWith(_PostfixInstantiatorSide) || value.EndsWith(_PostfixRemoteSide) ||
