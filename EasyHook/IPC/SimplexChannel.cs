...
namespace EasyHook.IPC
{
    ...
    /// </summary>
    internal class SimplexChannel<TEndPoint> where TEndPoint : EndPointObject
    {
...
#region Public Methods
        ...
        public void InitializeChannel()
        {
            ...
            RemotingConfiguration.RegisterWellKnownServiceType(
                _endPointConfig.RemoteObjectType, _channelProperties.EndPointName, _endPointConfig.ObjectMode);
        }
...
#region Private Static Methods
        ...
        private static void AssertEndpointConfigurationData(EndPointConfigurationData<TEndPoint> configData,
                                                            string paramName)
        {
            if (configData.AllowedClients == null)
                throw new ArgumentException("The given EndPointConfigurationData specifies an illegal value for " +
                                                "AllowedClients",
                                            paramName);
        }
