...
namespace EasyHook.IPC
{
    ...
    internal class DuplexChannel<TRemoteEndPoint> where TRemoteEndPoint : DuplexChannelEndPointObject
    {
...
#region Properties
        ...
        public string LocalEndPointUrl
        {
            get
            {
                return _localChannelProperties.Url;
            }
        }
        ...
        public bool IsLocalEndPointInstantiator
        {
            get
            {
                return _localChannelProperties.IsInstantiatorChannel;
            }
        }
...
#region Constructors
        ...
        /// <summary>
        /// Creates a new full duplex channel, in which the remote endpoint's <see cref="AppDomain"/> is the
        /// instantiator.
        /// </summary>
        /// <param name="localEndPointConfig">Configuration for the local endpoint.</param>
        ...
        public DuplexChannel(EndPointConfigurationData<TRemoteEndPoint> localEndPointConfig, string otherChannelUrl)
            : this(localEndPointConfig,
                   ChannelProperties.InitializeFromUrl(otherChannelUrl).GetRemoteEndpointChannelProperties())
        {
        }
        ...
        internal DuplexChannel(EndPointConfigurationData<TRemoteEndPoint> localEndPointConfig,
                               ChannelProperties serverChannelProperties)
        {
...
#region Public Methods
        ...
        /// <summary>
        /// Initializes the full duplex connection and calls <paramref name="onConnectionReady"/> when the connection is
        /// in a full duplex <see cref="State"/>.
        /// </summary>
...
#region Private Methods
        ...
        private void CreateClient(DuplexChannelReadyEventHandler<TRemoteEndPoint> callback)
        {
            ...
            else
            {
                ...
                DuplexChannelEndPointObject.SubscribeEndPointReadyEvent(_localEndPointConfig.RemoteObjectType,
                                                                        OnRemoteEndPointSignaledReady, callback);
            }
        }
        ...
        /// </exception>
        /// <param name="checkChannelStateFirst">Specifies whether or not <see cref="_state"/> must be checked
        /// first.</param> <returns></returns>
        private TRemoteEndPoint GetRemoteEndPoint(bool checkChannelStateFirst)
        {
            if (checkChannelStateFirst && (_state & DuplexChannelState.ClientUp) != DuplexChannelState.ClientUp)
                throw new ApplicationException("Unable to return remote endpoint due to channel state " + _state);
            // Get proxy.
            var remoteObject =
                Activator.GetObject(typeof(TRemoteEndPoint), _remoteChannelProperties.Url) as TRemoteEndPoint;
...
#region Private Static Methods
        ...
        /// And <see cref="ArgumentException"/> is thrown if any of <paramref name="configData"/>'s properties is
        /// invalid. The given <paramref name="paramName"/> is set to <see cref="ArgumentException.ParamName"/>.
        /// </exception>
        /// <param name="configData"></param>
        /// <param name="paramName"></param>
        private static void AssertEndpointConfigurationData(EndPointConfigurationData<TRemoteEndPoint> configData,
                                                            string paramName)
        {
        ...
        /// <summary>
        /// Returns a default <see cref="CommonSecurityDescriptor"/> based on the given collection of <see
        /// cref="WellKnownSidType"/>.
        /// </summary>
