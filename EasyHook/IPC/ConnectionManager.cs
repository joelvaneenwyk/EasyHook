...
{
    /// <summary>
    /// Class managing all connections between the current <see cref="AppDomain"/> and any other <see
    /// cref="AppDomain"/>, which might even run in a different process than the current one.
    /// </summary>
...
#region Public Methods
        ...
        {
            lock(_domainConnectionsSyncRoot) return _domainConnections.ContainsKey(id);
        }
        ...
        /// <returns></returns>
        public TEndPoint Connect<TEndPoint>(DomainIdentifier id) where TEndPoint : EndPointObject
        {
            ...
            lock(_domainConnectionsSyncRoot)
            {
                ...
                remoteDomainEndPoint = _domainConnections [id]
                                           .GetRemoteEndPoint();
            }
        ...
        /// <returns></returns>
        public bool TryConnect<TEndPoint>(DomainIdentifier id, out TEndPoint result) where TEndPoint : EndPointObject
        {
            if (!CanConnect(id))
            {
                result = null;
...
#region Internal Methods
        ...
        /// <summary>
        /// Initializes a new IPC connection which has a <see cref="DomainConnectionEndPoint"/> on both connection
        /// sides.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <remarks>
        /// To set up such a connection, call <see cref="InitializeInterDomainConnection"/> in the remote application
        /// domain.
        /// </remarks>
        ...
        internal string CreateChannel<TEndPoint>() where TEndPoint : EndPointObject
        {
