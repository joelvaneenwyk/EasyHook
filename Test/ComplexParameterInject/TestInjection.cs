...
namespace ComplexParameterInject
{
    ...
    public class TestInjection : EasyHook.IEntryPoint
    {
        ...
        public TestInjection(RemoteHooking.IContext context, String channelName, TestComplexParameter parameter)
        {
            // connect to host...
        ...
        public void Run(RemoteHooking.IContext context, String channelName, TestComplexParameter parameter)
        {
            try
            {
